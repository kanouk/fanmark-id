-- Move the fanmark availability check to emoji ID based lookups

DROP FUNCTION IF EXISTS public.check_fanmark_availability_secure(text);
DROP FUNCTION IF EXISTS public.check_fanmark_availability(text);

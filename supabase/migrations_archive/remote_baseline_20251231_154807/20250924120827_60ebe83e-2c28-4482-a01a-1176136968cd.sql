-- Rename display_name to fanmark_name in fanmark_basic_configs table
ALTER TABLE public.fanmark_basic_configs 
RENAME COLUMN display_name TO fanmark_name;

-- Update get_fanmark_by_emoji function to use new column name
...
-- Update get_fanmark_complete_data function to use new column name

...
export const RedirectLoading = ({ targetUrl, fanmark }: RedirectLoadingProps) => {
  ...
  const displayUrl = targetUrl.length > 40 ? `${targetUrl.substring(0, 37)}...` : targetUrl;
        ...
        <div className="rounded-3xl border border-primary/20 bg-background/95 p-8 shadow-[0_25px_60px_rgba(101,195,200,0.2)] backdrop-blur">
          ...
          <div className="relative mb-8 flex h-32 items-center justify-center">
            ...
            <div className="relative z-10 grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-4">
              ...
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-100 to-sky-100 text-primary animate-bounce justify-self-start"
            ...
            <div className="absolute inset-0">
              <ExternalLink className="absolute top-2 left-8 h-4 w-4 text-primary animate-pulse"
                            style={{ animationDelay: '0s' }} />
              <ArrowRight className="absolute top-6 right-6 h-3 w-3 text-accent animate-pulse"
                          style={{ animationDelay: '0.5s' }} />
              <ExternalLink className="absolute bottom-4 left-4 h-3 w-3 text-primary animate-pulse"
          ...
          <div className="text-center space-y-6">
            ...
            <div className="rounded-xl bg-muted/30 border border-border/50 p-4">
              ...
              <div className="text-foreground font-medium break-all text-sm">
                {displayUrl}
              </div>
            </div>

...
| Stripe checkout, customer portal, and webhooks | Retain Stripe; Worker owns authenticated initiation and idempotent webhook projection into user_subscriptions | PRODUCT:73-84,453-482; D1 webhook/reconciliation staging runtime; Customer Portal and Free-to-paid plan Checkout API are staged but selector-disabled; paid plan-change commands and sandbox acceptance remain |

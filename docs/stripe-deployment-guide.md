...
3. 以下を設定:
   ```
   エンドポイントURL: https://ppqgtbjykitqtiaisyji.supabase.co/functions/v1/stripe-webhook
...
stripe listen --forward-to https://ppqgtbjykitqtiaisyji.supabase.co/functions/v1/stripe-webhook
...
# または、Supabase Dashboard → Edge Functions → stripe-webhook → Logs
```
